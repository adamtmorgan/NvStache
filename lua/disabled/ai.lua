-- --------------------------------------------------
-- WARN: EXPERIMENTAL. In-editor AI has thus far been
-- suboptimal. Will be testing terminal-based AI
-- tooling outside of Neovim for now. See more:
--
...
-- --------------------------------------------------
-- Below is for Avante. Didn't have great success with it
-- so trying out other workflows.
-- --------------------------------------------------
